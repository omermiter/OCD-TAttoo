...
export default function InquiryForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    const msg = [
      "Hi! I'd like to book a session with OCD Tattoo.",
      "",
      `Name: ${fields.name}`,
  ...
  const ready = fields.name && fields.contact && fields.idea && fields.placement && fields.size
    ...
    <section id="book" className="py-24 md:py-32" style={{ backgroundColor: "#07050a" }}>
      <div className="mx-auto max-w-3xl px-6 lg:px-10">
        ...
        >
          ...
          >
            Fill in the details below and I'll receive your message on WhatsApp — pre-filled with everything
            I need. I get back to every inquiry within 24 hours.
          </p>
        </motion.div>
